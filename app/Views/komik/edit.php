...
<div class="container">
 <div class="row">
  <div class="col-8">
   ...
   <form action="http://localhost/ci4komik/public/komik/update/<?= $komik['no']; ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    ...
    <div class="form-group row">
     ...
     <div class="col-sm-2">
      <img src="http://localhost/ci4komik/public/img/<?= $komik['sampul']; ?>" class="img-thumbnail img-preview">
     </div>
     <div class="col-sm-8">
